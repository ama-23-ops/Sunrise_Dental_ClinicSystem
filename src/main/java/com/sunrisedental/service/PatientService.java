...
import com.sunrisedental.dao.PatientDAO;import com.sunrisedental.model.Patient;import com.sunrisedental.util.Validator;
import java.sql.SQLException;
public class PatientService {
    private final PatientDAO dao=new PatientDAO();
    public int save(Patient p)throws SQLException{
        Validator.require(p.getFirstName(),"First name");Validator.require(p.getAddress(),"Address");Validator.require(p.getContactNumber(),"Contact number");
